        ...
        <html>
            ...
            <body>
                <h1 class="h1center">
                    ...
                    <xsl:otherwise>You are not allowed</xsl:otherwise>
                    </xsl:choose>
                </h1>
        ...
        <table class="header_table">
            <tbody>
                ...
                <td class="td_header_role_value">
                    ...
                    <xsl:choose>
                        <xsl:when test="document($config.file)/Configuration/ClinicalDocument/confidentialityCode/@allowed  = 'true'">
                            <xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="document($config.file)/Configuration/ClinicalDocument/confidentialityCode/originalText  = 'allowed'">
            ...
            <table class="header_table">
                <tbody>
                    <xsl:for-each select="n1:author/n1:assignedAuthor">
                        <xsl:choose>
                        <xsl:when test="document($config.file)/Configuration/ClinicalDocument/author/assignedAuthor/@allowed='true'">
                        <tr>
                            <td class="td_header_role_name">
                                <span class="td_label">
                    ...
                    <tr>
                        <xsl:for-each select="n1:authenticator">
                            <tr>
                                ...
                                <td class="td_header_role_value">
                                    <xsl:choose>
                                    <xsl:when test="document($config.file)/Configuration/ClinicalDocument/authenticator/assignedEntity='allowed'">
                                    <xsl:call-template name="show-name">
            ...
            <xsl:for-each select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole">
                <xsl:if test="not(n1:id/@nullFlavor)">
                        <tr>
                            ...
                            <td class="td_header_role_value">
                                <xsl:choose>
                                <xsl:when test="document($config.file)/Configuration/ClinicalDocument/recordTarget/patientRole/patient/name/@allowed='true'">
                                        <xsl:call-template name="show-name">
                    ...
                    <xsl:choose>
                        <xsl:when test="document($config.file)/Configuration/ClinicalDocument/recordTarget/patientRole/patient/birthTime='allowed'">
                        <tr>
                            <td class="td_header_role_name">
                                <span class="td_label">
...
-->
 ...
 @mediaType='image/jpeg']">
    ...
    <xsl:template name="show-contactInfo">
        ...
        <xsl:choose>
        <xsl:when test="document($config.file)/Configuration/ClinicalDocument/recordTarget/patientRole/addr  = 'allowed'">
        ...
        <xsl:choose>
        <xsl:when test="document($config.file)/Configuration/ClinicalDocument/recordTarget/patientRole/telecom  = 'allowed'">
